...
public class AgentOptionsController {
	...
	public void chargerPage(OptionsController optionsController, Options options) {
	...
	private void sauvegarder() {
		if (tousLesChampsValides()) {
			Agent agent = new Agent(this.getNomTextField().getText(), this.getPrenomTextField().getText(),
					Integer.parseInt(this.getNumCAPSSATextField().getText()), this.getFonctionTextField().getText(),
					this.getResidenceAdminTextField().getText(), this.getUniteTavailTextField().getText(),
					Integer.parseInt(this.getCoefficientTextField().getText()),
					Integer.parseInt(this.getCodeAnalytiqueTextField().getText()));
			options.setAgent(agent);
			optionsController.fermerSecondaryStage();
		}
